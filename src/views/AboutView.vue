    ...
    return {
      ...
      tools: [
        ...
        },
        {
          id: 5,
          name: "CorelDraw",
          imageUrl: "https://cdn-icons-png.flaticon.com/128/15457/15457177.png",
          status: "Graphics Software",
        },
        {
          id: 6,
          name: "Adobe Ilustrator",
          imageUrl: "https://cdn-icons-png.flaticon.com/128/12622/12622930.png",
          status: "Graphics Software",
        },
        {
          id: 7,
          name: "Photoshop",
          imageUrl: "https://cdn-icons-png.flaticon.com/128/5968/5968520.png",
          status: "Graphics Software",
        },
      ],
    };
    ...
    <article data-page="about">
      <header>
        ...
        >
          About Me &nbsp;
          <div
            class="h-[1px] w-32 bg-[#6FE6FC] md:w-96 aos-init aos-animate"
      ...
      >
        <div class="flex justify-center">
          <div class="flex justify-center md:justify-start fadein-right">
            <img
              ...
              decoding="async"
              data-nimg="1"
              class="w-[350px] h-[350px] rounded-full border-4 border-[#6FE6FC] object-cover"
              src="/img/imam.png"
            />
          </div>
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hello! My name is Imam Khusain, an Informatics
            Engineering student with an interest in technology and design. My
            journey in the world of UI/UX design and web development started in
            2023 when I started experimenting with Figma and building simple web
            interfaces.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I'm passionate about collaboration, problem
            solving, and constantly learning new things in technology and
            design. Outside of coding and design, I enjoy staying active through
            sports-it's how I balance screen time and keeping my mind sharp. I'm
            always excited to explore new things new challenges and contribute
            to meaningful digital products.
          </p>
        </div>
      </section>
    </article>
  ...
  <div class="px-5 py-5 md:px-12 md:py-10 text-left text-amber-50 mx-3">
    <article data-page="about">
      <header>
        ...
        >
          <div
            class="h-[1px] w-10 bg-[#6FE6FC] md:w-20 aos-init aos-animate"
            data-aos="zoom-in-left"
            data-aos-duration="600"
          ></div>
          &nbsp; Skills
          ...
          >
            <li class="mr-2">
              <button
                ...
                :class="{
                  'text-[#6FE6FC] bg-[#6FE6FC] bg-opacity-10': activeTab === 1,
                }"
                @click="activeTab = 1"
              >
                Tech Stack
            ...
            <li class="mr-2">
              <button
                class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{
                  'text-[#6FE6FC] bg-[#6FE6FC] bg-opacity-10': activeTab === 2,
                }"
                @click="activeTab = 2"
              >
                Tools
        ...
        <div v-show="activeTab === 1">
          ...
          >
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-[#6FE6FC] px-2 py-2 hover:bg-amber-200 hover:bg-opacity-10 md:gap-3 lg:px-3"
              >
                <div
