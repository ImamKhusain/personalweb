<template>
    ...
    >
      ...
      >
        <button @click="redirectToHome" class="flex">
          <span
            class="self-center text-lg text-[#6FE6FC] font-semibold whitespace-nowrap fadein-bot hover:text-amber-100"
            >Imam Khusain</span
          >
        </button>
        <div class="flex gap-4 md:order-2 fadein-bot items-center">
          <a href="https://github.com/ImamKhusain"
            ><img
              class="w-9 rounded-full"
              src="https://seeklogo.com/images/G/github-logo-2E3852456C-seeklogo.com.png"
              alt="github"
          /></a>
          <a href="https://instagram.com/i.khusaiin"
            ><img
              class="w-9 h-9 rounded-none"
              src="https://images.seeklogo.com/logo-png/28/1/instagram-new-2016-glyph-logo-png_seeklogo-282176.png"
              alt="Instagram"
            />
          </a>
        </div>
  ...
  <footer
    class="block md:hidden fixed bottom-0 left-0 right-0 rounded-t-3xl border border-[#6FE6FC] bg-[#121212] bg-opacity-80 backdrop-blur-md backdrop-opacity-90"
  >
